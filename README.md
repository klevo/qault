...
* The secret file JSON structure is as follows: `{ uuid:, name:, secret:, created_at:, updated_at: }`.
...
3. Generates UUID v7, creates the secret JSON payload, encrypts it and saves it under data directory.
